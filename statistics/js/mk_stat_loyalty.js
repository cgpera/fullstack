...
*/
var mem_votes_w_party = miembros.map(el => [el.votes_with_party_pct, el.first_name, el.last_name, el.total_votes, el.party]).sort(ordenar_num)
...
obj_estad.less_loyalty = array_less
console.log(obj_estad.less_loyalty)
document.getElementById("less_voted").innerHTML = '<thead class="thead-light"> <tr><th scope="col">Num</th> <th scope="col" colspan=1>Names</th>' + 
...
// dibujo tabla
document.getElementById("most_voted").innerHTML = '<thead class="thead-light"> <tr><th scope="col">Num</th> <th scope="col" colspan=1>Names</th>' + 
'<th scope="col">Party</th> <th scope="col">Prom/Party</th><th scope="col">Total Votes</th></tr></thead><tbody>'
